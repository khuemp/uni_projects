...
public class MoralLoseTest extends SystemTest {
  public MoralLoseTest() {
    super(MoralLoseTest.class, false);
  }

  @Override
  protected String createConfig() {
    return Utils.loadResource(MoralLoseTest.class, "nullMoral.json");
  }
