...
public class CrisisAceTest extends SystemTest {

  public CrisisAceTest() {
    super(CrisisAceTest.class, false);
  }
  ...
  public void run() throws TimeoutException {
    ...
    this.assertActNow(1);
    this.sendContributeCard(1, 1033);
    this.assertContributed(1, 0, 1033);
    this.assertActNow(1);
    this.sendContributeCard(1, 1031);
    this.assertContributed(1, 0, 1031);
    this.assertActNow(1);
    this.sendEndTurn(1);
    this.assertColonyPhaseStarted(1);
    this.assertStarvationTokenAdded(1);
    this.assertMoralChanged(1, -1, MoralChange.STARVATION_TOKEN);
    this.assertMoralChanged(1, 1, MoralChange.CRISIS);
