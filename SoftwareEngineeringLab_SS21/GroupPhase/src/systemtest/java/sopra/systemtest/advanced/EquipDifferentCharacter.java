...
public class EquipDifferentCharacter extends SystemTest {

  public EquipDifferentCharacter() {
    super(EquipDifferentCharacter.class, false);
  }
  ...
  public String createConfig() {
    return Utils.loadResource(BarricadeWinTest.class, "basicConfigBlueprintWorkingTest.json");
  }
  ...
  public void run() throws TimeoutException {
    ...
    this.assertPlayer(1, 1, "T");
    this.assertPlayer(2, 0, "Jeff");
    this.assertPlayer(2, 1, "T");
    ...
    this.sendUseCard(1, 1031, 2004, 3001);
    this.assertCardUsed(1, 1031, 2004, 3001);
    this.assertActNow(1);
