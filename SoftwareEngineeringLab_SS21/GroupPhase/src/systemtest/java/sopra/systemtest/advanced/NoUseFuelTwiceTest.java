...
public class NoUseFuelTwiceTest extends SystemTest {

  public NoUseFuelTwiceTest() {
    super(NoUseFuelTwiceTest.class, false);
  }
  ...
  public void run() throws TimeoutException {
    ...
    this.assertActNow(1);
    this.sendUseCard(1, 1012, 2004, 3001);
    this.assertCardUsed(1, 1012, 2004, 3001);
    this.assertWasteChanged(1, 1);
    this.assertActNow(1);
    this.sendUseCard(1, 1012, 2004, 3000);
