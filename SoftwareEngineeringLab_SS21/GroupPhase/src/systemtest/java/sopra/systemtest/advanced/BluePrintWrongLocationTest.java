...
public class BluePrintWrongLocationTest extends SystemTest {

  public BluePrintWrongLocationTest() {
    super(BluePrintWrongLocationTest.class, false);
  }
  ...
  public String createConfig() {
    return Utils.loadResource(BarricadeWinTest.class, "basicConfigBlueprintTest.json");
  }
