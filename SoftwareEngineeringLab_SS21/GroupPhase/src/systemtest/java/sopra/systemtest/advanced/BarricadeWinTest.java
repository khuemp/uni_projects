...
public class BarricadeWinTest extends SystemTest {

  public BarricadeWinTest() {
    super(BarricadeWinTest.class, false);
  }

  @Override
  public String createConfig() {
    return Utils.loadResource(BarricadeWinTest.class, "barricade.json");
  }
