...
public class MoveSameLocationTest extends SystemTest {
  public MoveSameLocationTest() {
    super(MoveSameLocationTest.class, false);
  }

  @Override
  protected String createConfig() {
    return Utils.loadResource(MoveSameLocationTest.class, "basicConfig.json");
  }
