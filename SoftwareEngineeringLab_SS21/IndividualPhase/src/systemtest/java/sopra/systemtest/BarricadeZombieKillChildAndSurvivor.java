...
public class BarricadeZombieKillChildAndSurvivor extends SystemTest {
    public BarricadeZombieKillChildAndSurvivor() {
        super(BarricadeZombieKillChildAndSurvivor.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(BarricadeZombieKillChildAndSurvivor.class,
                "configurationKillChildAndSurvivor.json");
    }
    ...
    protected void run() throws TimeoutException, AssertionError {
        ...
        //crossroad 10
        this.assertActNow(1);
        this.sendMove(1, 23, 1);
        this.assertMoved(1, 23, 1);
        this.assertActNow(1);
        this.sendUseCard(1, 1097, 23, 0);
        this.assertCardUsed(1, 1097, 23, 0);
        ...
        this.assertBarricadeDestroyed(1, 1, 0);
