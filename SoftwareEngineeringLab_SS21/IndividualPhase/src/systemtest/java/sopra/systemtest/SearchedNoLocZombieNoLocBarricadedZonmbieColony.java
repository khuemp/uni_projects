...
public class SearchedNoLocZombieNoLocBarricadedZonmbieColony extends SystemTest {
    public SearchedNoLocZombieNoLocBarricadedZonmbieColony() {
        super(SearchedNoLocZombieNoLocBarricadedZonmbieColony.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(SearchedNoLocZombieNoLocBarricadedZonmbieColony.class,
